/*VALIDATHOR PLUGIN -- AUTHOR: Jérémy CHAMOIS */
;(function ($) {
                        ...
                        if(!validation($(input),validationType)){ // si la valid est fausse
                            ...
                            if(!$(input).closest('.'+self.settings.parentInput).hasClass(self.settings.errorClass)){ //et si l'element n'a pas deja d'erreur
                                ...
                                $(input) // je met la class erreur sur le parent
                                    ...
                                    .append('<'+self.settings.errorTag+' class="'+self.settings.errorMessageClass+'">'+validations[inputType][validationType].errorMessage+'</'+self.settings.errorTag+'>')
    ...
    $.BigVideo = function(options) {
        ...
        BigVideo.init = function() {
            if (!isInitialized) {
                ...
                var videoTechOrder = ['flash','html5'];
